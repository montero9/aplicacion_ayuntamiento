...
+ Noticias: este es uno de los apartados más importantes de la aplicación, ya que desde aquí se va a descargar las noticias que hay alojada en la base de datos de la web, por eso, hay que verificar que hay internet para evitar errores y controlarlos.
...
+ <strong>Contactar:</strong> esta opción va destinada a que los usuarios puedan resolver cualquier duda con el ayuntamiento.
