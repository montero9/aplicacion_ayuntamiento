package app.example.usuario.proyecto.barra_carga;
...
/**
 * Clase que permite generar una barra de carga mientras se obtine la información del servidor
 * Este código ha sido obtenido de github
 */
public class DelayedProgressDialog extends DialogFragment {
    private static final int DELAY_MILLISECOND = 0;
    private static final int SHOW_MIN_MILLISECOND = 500;
