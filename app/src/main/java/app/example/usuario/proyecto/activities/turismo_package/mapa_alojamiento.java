...
public class mapa_alojamiento extends AppCompatActivity implements OnMapReadyCallback, GoogleMap.OnInfoWindowClickListener  {
    ...
    LatLng pueblo=new LatLng(37.286904,  -6.385055);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(app.example.usuario.proyecto.R.layout.activity_mapa_restaurantes);
        ...
        if (infoRed != null) {
            ...
            mapView=(MapView) findViewById(app.example.usuario.proyecto.R.id.mv_restaurantes);
            ...
            Intent iSiguiente = new Intent(mapa_alojamiento.this, MainActivity.class);
            iSiguiente.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP | Intent.FLAG_ACTIVITY_SINGLE_TOP);
            startActivity(iSiguiente);
            finish();
            Toast.makeText(mapa_alojamiento.this,"Es necesario acceso a internet para ver el mapa",Toast.LENGTH_LONG).show();
        }
    }
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        setMarcador(37.286676,-6.384788,"Casa rural Los Pinos","Click para más información");
        setMarcador(37.242985,-6.381710,"Camping Doñarrayan","Click para más información");
    }
    ...
    private void setMarcador(Double lat, Double longi, String nombre, String informacion) {
        ...
        if (lat != 0 && longi != 0) {
            ...
            gMap.animateCamera(CameraUpdateFactory.newLatLngZoom(pueblo, 10));
    ...
    public void onInfoWindowClick(Marker marker) {
        ...
        switch (marker.getId()){
            case "m0":
                navegador = new Intent(mapa_alojamiento.this,web_info_marcador.class);
                navegador.putExtra("url",getResources().getString(app.example.usuario.proyecto.R.string.casa_rural_los_pinos));
                startActivity(navegador);
                break;
            case "m1":
                navegador = new Intent(mapa_alojamiento.this,web_info_marcador.class);
                navegador.putExtra("url",getResources().getString(app.example.usuario.proyecto.R.string.donarrayan));
                startActivity(navegador);
                break;
        }
    }
